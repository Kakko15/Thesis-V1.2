...
-- API. Any valid email address may create a student account; public registration
-- remains limited to CCSICT and cannot request a privileged role. Faculty accounts
